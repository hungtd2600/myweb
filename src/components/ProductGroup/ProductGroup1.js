...
export default function ProductGroup1() {
  return (
    <div className={cx('product')}>
        ...
        <Col>
          <div className={cx('block-title')} >
            <div className={cx('collection-name')}>
              ...
              <a className={cx('collection-link')} href='#t'> Sản phẩm mới </a>
            </div>
          </div>
        </Col>
      </Row>
      ...
      <Row>
        <Col>
          <img className={cx('product-img')} src='https://bizweb.dktcdn.net/100/239/632/themes/569586/assets/index_col_left_banner_1.jpg?1635568039150'></img>
        </Col>
      </Row>
